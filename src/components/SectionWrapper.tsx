...
const SectionWrapper = ({ children, id, className = '', title, subtitle }: SectionWrapperProps) => {
  return (
      ...
      <div className="tech-card floating-elements cyber-border max-w-7xl mx-auto animate-fade-in-scale">
        {title && (
          <div className="text-center mb-6">
            ...
            <div className="w-20 h-0.5 bg-gradient-to-r from-terminal-accent to-terminal-purple mx-auto mt-4 rounded-full animate-pulse-glow" />
          </div>
        )}
