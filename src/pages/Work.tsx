...
const Work = () => {
	return (
		<SectionWrapper
			...
			subtitle="$ git log --oneline --graph --all"
		>
			<div className="space-y-8">
				...
				<div className="bg-terminal-surface/40 border border-terminal-border rounded-lg p-4">
					...
					<div className="font-mono text-sm space-y-1">
						<div className="text-terminal-primary">
							$ git log --graph --pretty=format:'%h - %s (%cr)
							&lt;%an&gt;'
						</div>
						<div className="text-terminal-text mt-1">
							Showing professional commit history...
						</div>
				...
				<div className="grid grid-cols-1 md:grid-cols-4 gap-4">
					<div className="bg-terminal-surface/30 border border-terminal-primary/30 rounded-lg p-4 text-center">
						<div className="text-2xl font-bold text-terminal-primary font-mono">
							4+
						</div>
					...
					<div className="bg-terminal-surface/30 border border-terminal-secondary/30 rounded-lg p-4 text-center">
						<div className="text-2xl font-bold text-terminal-secondary font-mono">
							41+
						</div>
						<div className="text-sm text-terminal-muted font-mono">
							TECH STACK
